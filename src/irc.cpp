...
{
    // IRC peer discovery disabled: the 2009 IRC network no longer exists (and
    // what answers today crashes the parser). Replaced by Nostr relay
    // discovery.
    printf("ThreadIRCSeed: IRC peer discovery disabled (using Nostr)\n");
    return;
