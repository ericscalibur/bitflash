...
CMainFrameBase::CMainFrameBase(wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style) : wxFrame(parent, id, title, pos, size, style)
{
    ...
    m_menuOptionsGenerateBitcoins = new wxMenuItem(m_menuOptions, wxID_OPTIONSGENERATEBITCOINS, wxString(wxT("&Generate Coins (CPU)")), wxEmptyString, wxITEM_CHECK);
    ...
    m_staticText32 = new wxStaticText(this, wxID_ANY, wxT("Your Bitflash Address:"), wxDefaultPosition, wxDefaultSize, 0);
...
CAboutDialogBase::CAboutDialogBase(wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style) : wxDialog(parent, id, title, pos, size, style)
{
    ...
    m_staticText40 = new wxStaticText(this, wxID_ANY, wxT("Bitflash "), wxDefaultPosition, wxDefaultSize, 0);
    ...
    this->Layout();
    // Resize the dialog to fit all the About text (avoids the bottom being cut off)
    bSizer60->Fit(this);
...
CAddressBookDialogBase::CAddressBookDialogBase(wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style) : wxDialog(parent, id, title, pos, size, style)
{
    ...
    m_staticText55 = new wxStaticText(this, wxID_ANY, wxT("Bitflash Address"), wxDefaultPosition, wxDefaultSize, 0);
